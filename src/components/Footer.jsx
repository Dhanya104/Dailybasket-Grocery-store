      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-full bg-brand-green flex items-center justify-center border border-white/10">
                <span className="text-brand-gold font-bold text-xl font-serif">D</span>
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-xl text-white tracking-tight leading-none">Dailybasket</span>
                <span className="text-xs text-brand-gold uppercase tracking-widest font-medium">Grocery Store</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-brand-beige/80 text-sm">support@dailybasket.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-brand-beige/50 text-sm">
            &copy; {new Date().getFullYear()} Dailybasket Grocery Store. All rights reserved.
          </p>
