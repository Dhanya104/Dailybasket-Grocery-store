        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="flex-shrink-0 flex items-center gap-2 cursor-pointer">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-xl text-brand-green tracking-tight leading-none">Dailybasket</span>
              <span className="text-xs text-brand-brown uppercase tracking-widest font-medium">Grocery Store</span>
            </div>
          </div>
