...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      text: 'I have been buying from Dailybasket Grocery Store for 5 years. Now with the delivery app, it is so easy to order monthly provisions. Highly recommended!',
      rating: 5
    },
    {
      id: 3,
